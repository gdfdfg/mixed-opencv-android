#include "common.h"  
#include "Java_com_chuangweizong_opencv_lib_detect_TClip.h"
#include "tclip.h"
 ...
 */
JNIEXPORT  jobject JNICALL Java_com_chuangweizong_opencv_lib_detect_TClip_crop(JNIEnv *env, jobject instance, jstring config,
                                                                                     jobject bitmap_src, jint width, jint height){
